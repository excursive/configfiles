...
sudo apt-get install build-essential autoconf automake cmake valgrind lm-sensors curl lz4 python3-lxml python3-bs4 cargo rust-clippy rust-gdb rustc rustfmt rust-all
