...
manage_aseprite() {
  ...
  if [ "$(git config --get remote.origin.url)" != 'https://github.com/aseprite/aseprite.git' ] \
      || [ "$(git ls-remote --get-url origin)" != 'https://github.com/aseprite/aseprite.git' ] \
           || [ "$(git remote get-url origin)" != 'https://github.com/aseprite/aseprite.git' ]; then
  ...
  #    || [ "$(git ls-remote --get-url origin)" != 'https://chromium.googlesource.com/chromium/tools/depot_tools.git' ] \
  #         || [ "$(git remote get-url origin)" != 'https://chromium.googlesource.com/chromium/tools/depot_tools.git' ]; then
  ...
  if [ "$(git config --get remote.origin.url)" != 'https://skia.googlesource.com/skia.git' ] \
      || [ "$(git ls-remote --get-url origin)" != 'https://skia.googlesource.com/skia.git' ] \
         || [ "$(git remote --get-url origin)" != 'https://skia.googlesource.com/skia.git' ]; then
...
case "$1" in
  ...
  ;;
  '')
    printf '\nError: No parameters given, see -h or --help\n'
    exit 1
  ;;
  *)
